...
public class IC_EndPurifiedChrushedOre extends Item
{
    public IC_EndPurifiedChrushedOre(int i)
    {
        super(i);
        maxStackSize = 64;
		setCreativeTab(NewEnd_Main.Tab_newend); //place in creative tabs
		this.setUnlocalizedName(Strings.IC_EndPurifiedChrushedOre_NAME); //name of the block in texture folder
    }
