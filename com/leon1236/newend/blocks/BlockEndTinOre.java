...
public class BlockEndTinOre extends Block {
	...
	public BlockEndTinOre(int id) {
			...
			this.setUnlocalizedName(Strings.BlockEndTinOre_NAME); //name of the block in texture folder
			}
    ...
    {
        return com.leon1236.newend.blocks.EndIC2Blocks.BlockEndTinOre.blockID;
    }
