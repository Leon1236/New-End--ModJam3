...
public class BlockEndLeadOre extends Block {
	...
	public BlockEndLeadOre(int id) {
			...
			this.setUnlocalizedName(Strings.BlockEndLeadOre_NAME); //name of the block in texture folder
			}
    ...
    {
        return com.leon1236.newend.blocks.EndIC2Blocks.BlockEndLeadOre.blockID;
    }
