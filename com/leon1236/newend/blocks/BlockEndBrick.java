...
public class BlockEndBrick extends Block {

	public BlockEndBrick(int id) {
			...
			this.setUnlocalizedName(Strings.BlockEndBrick_NAME); //name of the block in texture folder
			}
    ...
    public int idDropped(int par1, Random par2Random, int par3)
     {
    return com.leon1236.newend.blocks.EndBlocks.BlockEndBrick.blockID;
     }
