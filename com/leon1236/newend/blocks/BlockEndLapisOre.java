...
public class BlockEndLapisOre extends Block {
	...
	public BlockEndLapisOre(int id) {
			...
			this.setUnlocalizedName(Strings.BlockEndLapisOre_NAME); //name of the block in texture folder
			}
    ...
    {
        return com.leon1236.newend.blocks.EndVanillaBlocks.BlockEndLapisOre.blockID;
    }
