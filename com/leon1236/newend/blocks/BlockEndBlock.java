...
public class BlockEndBlock extends Block {
	...
	public BlockEndBlock(int id) {
			...
			this.setUnlocalizedName(Strings.BlockEndBlock_NAME); //name of the block in texture folder
			}
    ...
    public int idDropped(int par1, Random par2Random, int par3)
     {
    return com.leon1236.newend.blocks.EndBlocks.BlockEndBlock.blockID;
     }
