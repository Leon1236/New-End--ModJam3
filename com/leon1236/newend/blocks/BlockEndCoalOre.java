...
public class BlockEndCoalOre extends Block {
	...
	public BlockEndCoalOre(int id) {
			...
			this.setUnlocalizedName(Strings.BlockEndCoalOre_NAME); //name of the block in texture folder
			}
    ...
    public int idDropped(int par1, Random par2Random, int par3)
     {
    return com.leon1236.newend.items.ModItems.ItemEndCoal.itemID;
     }
