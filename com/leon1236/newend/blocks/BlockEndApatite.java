...
public class BlockEndApatite extends Block {
	...
	public BlockEndApatite(int id) {
			...
			this.setUnlocalizedName(Strings.BlockEndApatiteOre_NAME); //name of the block in texture folder
			}
    ...
    {
        return com.leon1236.newend.blocks.EndForestryBlocks.BlockEndApatiteOre.blockID;
    }
