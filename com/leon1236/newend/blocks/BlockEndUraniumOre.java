...
public class BlockEndUraniumOre extends Block {
	...
	public BlockEndUraniumOre(int id) {
			...
			this.setUnlocalizedName(Strings.BlockEndUraniumOre_NAME); //name of the block in texture folder
			}
    ...
    {
        return com.leon1236.newend.blocks.EndIC2Blocks.BlockEndUraniumOre.blockID;
    }
