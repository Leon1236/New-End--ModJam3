...
public class BlockEndCopperOre extends Block {
	...
	public BlockEndCopperOre(int id) {
			...
			this.setUnlocalizedName(Strings.BlockEndCopperOre_NAME); //name of the block in texture folder
			}
    ...
    {
        return com.leon1236.newend.blocks.EndIC2Blocks.BlockEndCopperOre.blockID;
    }
