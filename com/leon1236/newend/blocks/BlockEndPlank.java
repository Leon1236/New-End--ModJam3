...
public class BlockEndPlank extends Block {

	public BlockEndPlank(int id) {
			...
			this.setUnlocalizedName(Strings.BlockEndPlank_NAME); //name in class string of the block in texture folder
			}
    ...
    public int idDropped(int par1, Random par2Random, int par3)
     {
    return com.leon1236.newend.blocks.EndBlocks.BlockEndPlank.blockID;
     }
