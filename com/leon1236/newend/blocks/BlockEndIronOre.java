...
public class BlockEndIronOre extends Block {
	...
	public BlockEndIronOre(int id) {
			...
			this.setUnlocalizedName(Strings.BlockEndIronOre_NAME); //name of the block in texture folder
			}
    ...
    {
        return com.leon1236.newend.blocks.EndVanillaBlocks.BlockEndIronOre.blockID;
    }
