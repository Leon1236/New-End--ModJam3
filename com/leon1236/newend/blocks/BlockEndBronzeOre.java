...
public class BlockEndBronzeOre extends Block {
	...
	public BlockEndBronzeOre(int id) {
			...
			this.setUnlocalizedName(Strings.BlockEndBronzeOre_NAME); //name of the block in texture folder
			}
    ...
    {
        return com.leon1236.newend.blocks.EndIC2Blocks.BlockEndBronzeOre.blockID;
    }
